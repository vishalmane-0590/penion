...
type LayoutRouteId = RouteId | "/" | "/(app)/cases" | "/(app)/client" | "/(app)/client/[id]" | "/(app)/client/[id]/manage" | "/(app)/dashboard" | "/(app)/find" | "/(app)/project/[id]" | "/(app)/project/view" | "/(auth)/login" | "/fill/[token]" | null
